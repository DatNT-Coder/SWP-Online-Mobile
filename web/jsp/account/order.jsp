<%-- 
    Document   : order
    Created on : Jan 27, 2025, 3:08:28 PM
    Author     : naokh
--%>
...
<html>
          <head>
                    ...
                    <link href="/Content/web/css/styles.users.css?c=638735872895979371" rel="stylesheet" />
          ...
          <body class="account">
                                                                                ...
                                                                                <ul>
                                                                                          ...
                                                                                          <li>
                                                                                                    <form action="/Account/LogOff" id="logoutForm" method="post">
                                                                                                              <input type="hidden" name="ReturnUrl" id="ReturnUrl" value="/account/order" />
                                                                                                              <input name="__RequestVerificationToken" type="hidden" value="-Oq9WJhjKxcqM7zS-dLjouMUTJAXC-DdrFZJGmgBZMl_4gyP1-R8s5nVlVjs98we7tUyq0zNd1jSmmZQK-j82vFiksY7U8sypSrJUoi40iHa1MEB2qW_9Vc1d1UkY-4SMIhqyQ2" />
                    ...
                    <form action="/Account/LogOff" id="logoutForm" method="post">
                              <input type="hidden" name="ReturnUrl" id="ReturnUrl" value="/account/order" />
                              <input name="__RequestVerificationToken" type="hidden" value="LYNbPy8TpUHhZW1KappEOGTFVa5wKwP_hSWWApFrb4m8ut0QJlcflxcT4KAEe5deIw1WyworPN9rbPEMsazU1l96jN20Y1UXf64cykGeOr9NceHgtc624q6SKyZNtAFy_2_Ofg2" />
                    </form>
                    ...
                    <section class="account">
                              ...
                              <div class="body-content">
                                        ...
                                        <div class="header">
                                                  ...
                                                  <div class="icon">
                                                            <img src="/Content/web/content-icon/icon-account-order.png" />
                                                  </div>
                                        </div>
                    ...
                    <script src="/Content/web/js/app.users.js?c=638735872895979371"></script>
                    <script type="text/javascript">
