<%-- 
    Document   : wishlist
    Created on : Jan 27, 2025, 3:10:15 PM
    Author     : naokh
--%>
...
<html>
          <head>
                    ...
                    <link href="/Content/web/css/styles.users.css?c=638735873894982505" rel="stylesheet" />
          ...
          <body class="account">
                                                                                ...
                                                                                <ul>
                                                                                          ...
                                                                                          <li>
                                                                                                    <form action="/Account/LogOff" id="logoutForm" method="post">
                                                                                                              <input type="hidden" name="ReturnUrl" id="ReturnUrl" value="/account/wishlist" />
                                                                                                              <input name="__RequestVerificationToken" type="hidden" value="j87_Mlpn8coWFap7jsH_F4DkeYh4mBanomg4zpwzSnW3V1L2g9__pEN-mFyI1Rj4FY9SNx4u-qAtOABkoKJqP7Mn46l5jxmZizWa03QIhjONdQFXeoVZvebwxIfcq9T6BuE5Pg2" />
                    ...
                    <form action="/Account/LogOff" id="logoutForm" method="post">
                              <input type="hidden" name="ReturnUrl" id="ReturnUrl" value="/account/wishlist" />
                              <input name="__RequestVerificationToken" type="hidden" value="KEtwZdS4KdsqQ3TI31Z8mKeZTdN4Qf5O15pCtEtkwYpVVWsHU3Qkrwy9My1_QBEz-Hx3MiGJ_aFNkqtz9GR8LjiJ8JS3-IBshcIbbLG5JkjaeNpGTtRavol0AF2VGaNd4eTJbQ2" />
                    </form>
                    ...
                    <section class="account">
                              ...
                              <div class="body-content">
                                        ...
                                        <div class="header">
                                                  ...
                                                  <div class="icon">
                                                            <img src="/Content/web/content-icon/icon-account-wishlist.png" style="margin-bottom:-26px;" />
                                                  </div>
                                        </div>
