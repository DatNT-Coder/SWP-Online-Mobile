...
<div class="sidebar">
   ...
   <h2 class="sidebar-title">Sale</h2>
   <ul class="sidebar-menu">
      <li><a href="/ProjectSWP391/sale/saleDashboard"><i class="bi bi-speedometer2"></i> Thống kê</a></li>
      <li><a href="/ProjectSWP391/sale/ListOrderSale"><i class="bi bi-cart-check"></i> Danh sách đơn hàng</a></li>
   </ul>
</div>
