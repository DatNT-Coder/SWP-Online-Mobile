<%-- 
    Document   : bloglist
    Created on : Mar 6, 2025, 9:07:39 AM
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="postTitle" placeholder="Nhập tiêu đề bài viết">
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="postStatus">
                                    ...
                                    <option value="0" selected>Nháp</option>
                                </select>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="postBrief" class="form-label">Mô tả ngắn</label>
                            <textarea class="form-control" id="postBrief" rows="2" placeholder="Nhập mô tả ngắn"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="postContent" class="form-label">Nội dung chi tiết</label>
                            <textarea class="form-control" id="postContent" rows="6" placeholder="Nhập nội dung chi tiết"></textarea>
                        </div>
                        <div class="mb-3">
