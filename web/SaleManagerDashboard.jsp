        ...
        <div class="col-md-3">
            ...
            <div class="col-md-9">
                <section class="content">
                    ...
                    <!-- Search Form -->
                    <form action="listOsalemanageDashboardrderSale" method="get">
                    ...
                    <!-- Sort Form -->
                    <form action="salemanageDashboard" method="get">
                        <label>Sort By:</label>
                        <select name="sortBy">
                ...
                for (Order order : orders) { %>
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/salemanage/smdetail?orderid=<%= order.getId() %>" class="btn btn-warning btn-sm">Edit</a>
                            </td>
                        </tr>
                        <% } } %>
                    </tbody>
