...
<div class="sidebar">
   ...
   <ul class="sidebar-menu">
      <li><a href="/ProjectSWP391/admin/adminDashBoard"><i class="bi bi-speedometer2"></i> Thống kê</a></li>
      <li><a href="/ProjectSWP391/admin/listSettingAdmin"><i class="bi bi-gear"></i> Danh sách cài đặt</a></li>
      <li><a href="/ProjectSWP391/admin/userlist"><i class="bi bi-people"></i> Danh sách người dùng</a></li>
   </ul>
</div>
