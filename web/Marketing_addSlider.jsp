<%-- 
    Document   : Marketing_addProduct
    Created on : Feb 8, 2024, 3:12:15 PM
    Author     : alexf
--%>
...
<html>
    <head>
        ...
        <title>Marketing | Thêm slider</title>
    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <form id="myForm" action="/mobileshop/marketing/manageSliderMarketing" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="msg" value="addSlider"/>
                        ...
                        <div class="col-md-7 mb-3">
                            ...
                            <input required="" type="text" name="pName" class="form-control w-100">
                        </div>
                         <div class="col-md-7 mb-3">
                            <label>
                                <h4>Chi tiết</h4>
                            ...
                            <input required="" type="text" name="details" class="form-control w-100">
                        </div>
                       <div class="col-md-7 mb-3">
                            <label>
                                <h4>Back Link</h4>
                            ...
                            <input required="" type="text" name="backlink" class="form-control w-100">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-3">
                                <input required="" type="file" id="id" name="productImage" accept="image/*">
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="text-left col-md-3 mt-4">
                                <button id="confirmButton" class="btn btn-primary" type="submit">Thêm slider</button>
        ...
        <script>
            document.getElementById("confirmButton").addEventListener("click", function (event) {
                const isConfirmed = confirm("Bạn có chắc muốn thêm trang quảng cáo này?");
                if (isConfirmed) {
