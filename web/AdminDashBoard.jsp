...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <!-- Sidebar -->
            <div class="col-md-3" style="font-size: 0.85rem;padding: 0.5rem 1rem;max-width: 300px;"><jsp:include page="Admin_sidebar.jsp"></jsp:include></div>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    Thu nhập</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><fmt:formatNumber value="${requestScope.totalMonth}" type = "currency" /></div>
                                            </div>
                                            <div class="col-auto">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                    Số người mới đăng ký</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">${requestScope.totalLW}</div>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                    Sản phẩm</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">${requestScope.totalProducts}</div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-comments fa-2x text-gray-300"></i>
                                            </div>
