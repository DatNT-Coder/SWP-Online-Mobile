                    ...
                    <div class="col-md-9">
                        ...
                        <form id="myForm" action="/ProjectSWP391/admin/manageSettingAdmin" method="post">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input value="${setting.id}" readonly="" required="" type="text" name="sid" class="form-control w-100">
                        </div>
                        <div class="col-md-5 mb-3">
                            ...
                            <select required="" class="form-control" id="id" name="type">
                                ...
                                <c:forEach items="${requestScope.listType}" var="listType">
                                    <option value="${listType.type}" <c:if test="${setting.type == listType.type}">selected</c:if>>${listType.type}</option>
                                </c:forEach>
                        ...
                        <div class="col-md-7 mb-3">
                            ...
                            <input value="${setting.name}" required="" type="text" name="sName" class="form-control w-100">
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input value="${setting.value}" required="" type="text" name="value" class="form-control w-100">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input value="${setting.order}" required="" type="text" name="order" class="form-control w-100" pattern="^\d+(\.\d+)?$" title="vui lòng nhập số" >
                        </div>
                        <div class="col-md-4 mb-3">
                            <label>
                            ...
                            <select required="" class="form-control" id="id" name="status">
                                ...
                                <option value="1" <c:if test="${setting.isActive == 1}">selected</c:if>>Hoạt động</option>
                                <option value="0" <c:if test="${setting.isActive == 0}">selected</c:if>>Không hoạt động</option>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea required="" id="id" name="description" rows="5" cols="10" class="form-control w-100">${setting.description}</textarea>
                        </div>
                        <div class="mt-4"></div>
                        <div class="col-md-12">
                            <div class="text-left col-md-3 mt-4">
                                <button id="confirmButton" class="btn btn-primary" type="submit">Sửa sản phẩm</button>
