   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      try (PrintWriter out = response.getWriter()) {
         ...
         try {
            ...
            response.sendRedirect("BlogPostList");
            return;
         }
         ...
         int postPerPage = 3; // Same as in BlogPostList

         // Get posts by category
         BlogPostDAO blogDAO = new BlogPostDAO();
         int blogCount = blogDAO.getPostCountByCategory(categoryId);
         ArrayList<BlogPost> listPost = blogDAO.getPostsByCategory(categoryId, index, postPerPage);
