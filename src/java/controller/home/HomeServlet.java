...
public class HomeServlet extends HttpServlet {
          ...
          protected void doGet(HttpServletRequest request, HttpServletResponse response)
                  throws ServletException, IOException {
                    ...
                    // SQL query to get brand product counts
                    String query = "SELECT brand, COUNT(*) AS product_count FROM products GROUP BY brand";
                    ...
                    // Set brand counts in request attribute
                    request.setAttribute("brandCounts", brandCounts);

                    // Forward to JSP
                    request.getRequestDispatcher("homepages.jsp").forward(request, response);
          }
