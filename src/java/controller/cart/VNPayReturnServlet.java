    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("00".equals(vnp_ResponseCode)) {  // Thanh toán thành công
            ...
            String content = "<!DOCTYPE html>\n"
                    ...
                    + "              <a href=\"http://localhost:8080/ProjectSWP391/HomePage\" target=\"_blank\" style=\"display: inline-block;\">\n"
                    ...
                    + "              <p style=\"margin: 0;\">Đây là chi tiết đơn hàng của bạn. Nếu bạn có thắc mắc liên hê chê tôi ở đây <a href=\"http://localhost:8080/ProjectSWP391/Home\">contact us</a>.</p>\n"
                    + "            </td>\n"
                    + "          </tr>\n"
                    + "          <!-- end copy -->\n"
                    + "\n"
