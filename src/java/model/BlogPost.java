...
public class BlogPost {
    ...
    public BlogPost(int id, String title, String brief_info, String thumbnail, String details, Date updatedDate, int PostCategories_id, int User_id, boolean flag_feature, int status, String blogs_postscol, String full_name) {
        this.id = id;
        this.title = title;
       ...
       public BlogPost(int id, String title, String brief_info, String thumbnail, String details, Date updatedDate, int PostCategories_id, int User_id, boolean flag_feature, int status, String blogs_postscol) {
        this.id = id;
        this.title = title;
        this.brief_info = brief_info;
        this.thumbnail = thumbnail;
    ...
    public BlogPost(int id, String title, String brief_info, String thumbnail, String details, Date updatedDate, int PostCategories_id, int User_id, boolean flag_feature, int status, String blogs_postscol, String full_name, String name) {
        this.id = id;
        this.title = title;
        this.brief_info = brief_info;
        this.thumbnail = thumbnail;
